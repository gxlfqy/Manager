...
void CManagerDlg::DoDataExchange(CDataExchange* pDX)
{
	...
	DDX_Control(pDX, IDC_MFCMENUBUTTON, m_menuBottomCtrl);
	DDX_Control(pDX, IDC_MFCMENUBUTTON_GLAND, m_MFCMenuGlandCtrl);
}
...
BEGIN_EASYSTATICCTRLCONNECT_MAP(CManagerDlg)
	//Basic Info Static 
	ESCC_CONNECT(IDC_NAME_STATIC, IDC_BASICINFO_NAME,  "Edit_Control", 0)
	ESCC_CONNECT(IDC_SEX_STATIC, IDC_BASICINFO_SEX,  "Combo_Box", 0)
	ESCC_CONNECT(IDC_AGE_STATIC, IDC_BASICINFO_AGE, "Edit_Control", 0)
	ESCC_CONNECT(IDC_SMOKEYEAR_STATIC, IDC_BASICINFO_SMOKEYEAR,  "Combo_Box", 0)
	ESCC_CONNECT(IDC_SMOKENUM_STATIC, IDC_BASICINFO_SMOKENUM, "Edit_Control", ES_NUMBER)
	ESCC_CONNECT(IDC_SYMPTOM_STATIC, IDC_BASICINFO_SYMPTOM, "Combo_Box", 0)
	ESCC_CONNECT(IDC_COUGH_STATIC, IDC_BASICINFO_COUGH, "Combo_Box", 0)
	ESCC_CONNECT(IDC_HEMOPTYSIS_STATIC, IDC_BASICINFO_HEMOPTYSIS, "Combo_Box", 0)
	ESCC_CONNECT(IDC_FHOC_STATIC, IDC_BASICINFO_FHOC, "Combo_Box", 0)
	ESCC_CONNECT(IDC_FHOLC_STATIC, IDC_BASICINFO_FHOLC, "Combo_Box", 0)
	ESCC_CONNECT(IDC_OMTH_STATIC, IDC_BASICINFO_OMTH, "Combo_Box", 0)
	ESCC_CONNECT(IDC_EMPHYSEMA1_STATIC, IDC_BASICINFO_EMPHYSEMA1, "Combo_Box", 0)
	ESCC_CONNECT(IDC_TUBERCULOSIS_STATIC, IDC_BASICINFO_TUBERCULOSIS, "Combo_Box", 0)
	ESCC_CONNECT(IDC_SILICOSIS_STATIC, IDC_BASICINFO_SILICOSIS, "Combo_Box", 0)
	ESCC_CONNECT(IDC_HBP_STATIC, IDC_BASICINFO_HBP, "Combo_Box", 0)
	ESCC_CONNECT(IDC_CARDIOPATHY_STATIC, IDC_BASICINFO_CARDIOPATHY, "Combo_Box", 0)
	ESCC_CONNECT(IDC_CEREBROVASCULAR_DISEASE_STATIC, IDC_BASICINFO_CEREBROVASCULAR_DISEASE, "Combo_Box", 0)
	ESCC_CONNECT(IDC_DIABETES_STATIC, IDC_BASICINFO_DIABETES, "Combo_Box", 0)
	ESCC_CONNECT(IDC_NEPHROPATHY_STATIC, IDC_BASICINFO_NEPHROPATHY, "Combo_Box", 0)
	ESCC_CONNECT(IDC_OSMH_STATIC, IDC_BASICINFO_OSMH, "Combo_Box", 0)

	//CT check Static
	ESCC_CONNECT(IDC_CTNO_STATIC, IDC_CTCHECK_CTNO, "Edit_Control", 0)
	ESCC_CONNECT(IDC_CTDATE_STATIC, IDC_CTCHECK_CTDATE,  "Date_Time_Picker", 0)
	ESCC_CONNECT(IDC_CTRAISE_STATIC, IDC_CTCHECK_CTRAISE, "Combo_Box", 0)
	ESCC_CONNECT(IDC_MACHINENAME_STATIC, IDC_CTCHECK_MACHINENAME, "Combo_Box", 0)
	ESCC_CONNECT(IDC_SCANNING_SLICE_STATIC, IDC_CTCHECK_SCANNING_SLICE, "Edit_Control", ES_NUMBER)

	//PNR Static
	ESCC_CONNECT(IDC_MAJOR_AXIS_STATIC, IDC_PNR_MAJOR_AXIS, "Edit_Control", ES_NUMBER)
	ESCC_CONNECT(IDC_MINOR_AXIS_STATIC, IDC_PNR_MINOR_AXIS, "Edit_Control", ES_NUMBER)
	ESCC_CONNECT(IDC_SIZE_STATIC, IDC_PNR_SIZE, "Edit_Control", ES_NUMBER)
	ESCC_CONNECT(IDC_DENSITY_STATIC, IDC_PNR_DENSITY, "Combo_Box", 0)
	ESCC_CONNECT(IDC_SHAPE_STATIC, IDC_PNR_SHAPE, "Combo_Box", 0)
	ESCC_CONNECT(IDC_PART_STATIC, IDC_PNR_PART, "Combo_Box", 0)
	ESCC_CONNECT(IDC_PERIACINAR_EMPHYSEMA_STATIC, IDC_PNR_PERIACINAR_EMPHYSEMA, "Combo_Box", 0)
	ESCC_CONNECT(IDC_MULTIPLE_NODES_STATIC, IDC_PNR_MULTIPLE_NODES, "Combo_Box", 0)
	ESCC_CONNECT(IDC_PLEURAL_CONTACT_STATIC, IDC_PNR_PLEURAL_CONTACT, "Combo_Box", 0)
	ESCC_CONNECT(IDC_RAG_STATIC, IDC_PNR_RAG, "Combo_Box", 0)
	ESCC_CONNECT(IDC_LEAFLET_STATIC, IDC_PNR_LEAFLET, "Combo_Box", 0)
	ESCC_CONNECT(IDC_PRE_STATIC, IDC_PNR_PRE, "Edit_Control", 0)

	//OLD Static 
	ESCC_CONNECT(IDC_EMPHYSEMA2_STATIC, IDC_OLD_EMPHYSEMA2, "Combo_Box", 0)
	ESCC_CONNECT(IDC_IPF_STATIC, IDC_OLD_IPF, "Combo_Box", 0)
	ESCC_CONNECT(IDC_BRONCHIECTASIA_STATIC, IDC_OLD_BRONCHIECTASIA, "Combo_Box", 0)
	ESCC_CONNECT(IDC_OPTUBE_STATIC, IDC_OLD_OPTUBE, "Combo_Box", 0)
	ESCC_CONNECT(IDC_CAOFTHEP_STATIC, IDC_OLD_CAOFTHEP, "Combo_Box", 0)
	ESCC_CONNECT(IDC_PLEURAL_EFFUSION_STATIC, IDC_OLD_PLEURAL_EFFUSION, "Combo_Box", 0)

	//EXCHECK Static 
	ESCC_CONNECT(IDC_BTMWE_STATIC, IDC_EXCHECK_BTMWE, "Combo_Box", 0)
	ESCC_CONNECT(IDC_PFE_STATIC, IDC_EXCHECK_PFE, "Combo_Box", 0)
	ESCC_CONNECT(IDC_EX1_STATIC, IDC_EXCHECK_EX1, "Combo_Box", 0)
	ESCC_CONNECT(IDC_CEA1_STATIC, IDC_EXCHECK_CEA1, "Combo_Box", 0)
	ESCC_CONNECT(IDC_CA1991_STATIC, IDC_EXCHECK_CA1991, "Combo_Box", 0)
	ESCC_CONNECT(IDC_CYFRA21_1_1_STATIC, IDC_EXCHECK_CYFRA21_1_1, "Combo_Box", 0)
	ESCC_CONNECT(IDC_NSE_1_STATIC, IDC_EXCHECK_NSE_1, "Combo_Box", 0)
	ESCC_CONNECT(IDC_PET_CT_1_STATIC, IDC_EXCHECK_PET_CT_1, "Combo_Box", 0)
	ESCC_CONNECT(IDC_EX2_STATIC, IDC_EXCHECK_EX2, "Edit_Control", 0)
	ESCC_CONNECT(IDC_LYMPH_GLAND_STATIC, IDC_EXCHECK_LYMPH_GLAND, "Combo_Box", 0)
	ESCC_CONNECT(IDC_TRANSFER_STATIC, IDC_EXCHECK_TRANSFER, "Combo_Box", 0)

	//SURGERY Static
	ESCC_CONNECT(IDC_SURGERY_DATE_STATIC, IDC_SURGERY_DATE, "Date_Time_Picker", 0)
	ESCC_CONNECT(IDC_SURGERY_TIME_STATIC, IDC_SURGERY_TIME, "Edit_Control", ES_NUMBER)
	ESCC_CONNECT(IDC_SURGERY_NAME_STATIC, IDC_SURGERY_NAME, "Combo_Box", 0)
	ESCC_CONNECT(IDC_LYMPH_GLAND_2_STATIC, IDC_MFCMENUBUTTON_GLAND, "MFC_MenuButton_Control", 0)

	//PATHOLOGY Static
	ESCC_CONNECT(IDC_PATHOLOGY_NO_STATIC, IDC_PATHOLOGY_NO, "Edit_Control", 0)
	ESCC_CONNECT(IDC_PATHOLOGY_DATE_STATIC, IDC_PATHOLOGY_DATE, "Date_Time_Picker", 0)
	ESCC_CONNECT(IDC_PATHOLOGY_PART_STATIC, IDC_PATHOLOGY_PART, "Combo_Box", 0)
	ESCC_CONNECT(IDC_PATHOLOGY_SIZE_STATIC, IDC_PATHOLOGY_SIZE, "Edit_Control", ES_NUMBER)
	ESCC_CONNECT(IDC_PATHOLOGY_MAJOR_AXIS_STATIC, IDC_PATHOLOGY_MAJOR_AXIS, "Edit_Control", ES_NUMBER)
	ESCC_CONNECT(IDC_PATHOLOGY_TYPES_STATIC, IDC_PATHOLOGY_TYPES, "Combo_Box", 0)
	ESCC_CONNECT(IDC_PATHOLOGY_TDOP_STATIC, IDC_PATHOLOGY_TDOP, "Combo_Box", 0)
	//
	ESCC_CONNECT(IDC_PATHOLOGY_BIM_STATIC, IDC_PATHOLOGY_BIM, "Combo_Box", 0)
	ESCC_CONNECT(IDC_PATHOLOGY_VCE_STATIC, IDC_PATHOLOGY_VCE, "Combo_Box", 0)
	ESCC_CONNECT(IDC_PATHOLOGY_ADENOCARCINOMA_STATIC, IDC_MFCMENUBUTTON, "MFC_MenuButton_Control", 0)
	ESCC_CONNECT(IDC_PATHOLOGY_VLD_STATIC, IDC_PATHOLOGY_VLD, "Combo_Box", 0)
	ESCC_CONNECT(IDC_PATHOLOGY_LIGAMENT_STATIC, IDC_PATHOLOGY_LIGAMENT, "Combo_Box", 0)
	ESCC_CONNECT(IDC_PATHOLOGY_NERVE_STATIC, IDC_PATHOLOGY_NERVE, "Combo_Box", 0)
	//
	ESCC_CONNECT(IDC_PATHOLOGY_EMPHYSEMA_STATIC, IDC_PATHOLOGY_EMPHYSEMA, "Combo_Box", 0)
	ESCC_CONNECT(IDC_PATHOLOGY_PIF_STATIC, IDC_PATHOLOGY_PIF, "Combo_Box", 0)
	ESCC_CONNECT(IDC_PATHOLOGY_LNM_STATIC, IDC_PATHOLOGY_LNM, "Combo_Box", 0)
	ESCC_CONNECT(IDC_PATHOLOGY_INFLAMMATION_STATIC, IDC_PATHOLOGY_INFLAMMATION, "Combo_Box", 0)
	ESCC_CONNECT(IDC_PATHOLOGY_INFO1_STATIC, IDC_PATHOLOGY_INFO1, "Edit_Control", 0)
	ESCC_CONNECT(IDC_PATHOLOGY_PATHOLOGICAL_STAGE_STATIC, IDC_PATHOLOGY_PATHOLOGICAL_STAGE, "Edit_Control", 0)
	//

	//IMMUNOHISTOCHEMISTRY Static
	ESCC_CONNECT(IDC_IMMUNOHISTOCHEMISTRY_EGFR_STATIC, IDC_IMMUNOHISTOCHEMISTRY_EGFR, "Combo_Box", 0)
	ESCC_CONNECT(IDC_IMMUNOHISTOCHEMISTRY_CK7_STATIC, IDC_IMMUNOHISTOCHEMISTRY_CK7, "Combo_Box", 0)
	ESCC_CONNECT(IDC_IMMUNOHISTOCHEMISTRY_TTF_1_STATIC, IDC_IMMUNOHISTOCHEMISTRY_TTF_1, "Combo_Box", 0)
	ESCC_CONNECT(IDC_IMMUNOHISTOCHEMISTRY_CEA_STATIC, IDC_IMMUNOHISTOCHEMISTRY_CEA, "Combo_Box", 0)
	ESCC_CONNECT(IDC_IMMUNOHISTOCHEMISTRY_VIM_STATIC, IDC_IMMUNOHISTOCHEMISTRY_VIM, "Combo_Box", 0)
	ESCC_CONNECT(IDC_IMMUNOHISTOCHEMISTRY_CD34_STATIC, IDC_IMMUNOHISTOCHEMISTRY_CD34, "Combo_Box", 0)
	ESCC_CONNECT(IDC_IMMUNOHISTOCHEMISTRY_KI67_STATIC, IDC_IMMUNOHISTOCHEMISTRY_KI67, "Combo_Box", 0)
	ESCC_CONNECT(IDC_IMMUNOHISTOCHEMISTRY_NASPIN_A_STATIC, IDC_IMMUNOHISTOCHEMISTRY_NASPIN_A, "Combo_Box", 0)
	ESCC_CONNECT(IDC_IMMUNOHISTOCHEMISTRY_P63_STATIC, IDC_IMMUNOHISTOCHEMISTRY_P63, "Combo_Box", 0)
	
	//GENETIC_TESTING Static
	ESCC_CONNECT(IDC_GENETIC_TESTING_1_STATIC, IDC_GENETIC_TESTING, "Combo_Box", 0)
	ESCC_CONNECT(IDC_GENETIC_TESTING_BML4_ALK_STATIC, IDC_GENETIC_TESTING_BML4_ALK, "Combo_Box", 0)

	//FOLLOW_UP_RECORDS Static
	ESCC_CONNECT(IDC_FOLLOW_UP_RECORDS_CT_NO_STATIC, IDC_FOLLOW_UP_RECORDS_CT_NO, "Edit_Control", 0)
	ESCC_CONNECT(IDC_FOLLOW_UP_RECORDS_DATE_STATIC, IDC_FOLLOW_UP_RECORDS_DATE, "Date_Time_Picker", 0)
	ESCC_CONNECT(IDC_FOLLOW_UP_RECORDS_TIME_STATIC, IDC_FOLLOW_UP_RECORDS_TIME, "Edit_Control", ES_NUMBER)
	ESCC_CONNECT(IDC_FOLLOW_UP_RECORDS_SITUATION_STATIC, IDC_FOLLOW_UP_RECORDS_SITUATION, "Combo_Box", 0)
	ESCC_CONNECT(IDC_FOLLOW_UP_RECORDS_AFTERTREATMENT_STATIC, IDC_FOLLOW_UP_RECORDS_AFTERTREATMENT, "Combo_Box", 0)
	ESCC_CONNECT(IDC_FOLLOW_UP_RECORDS_CHEMOTHERAPY_STATIC, IDC_FOLLOW_UP_RECORDS_CHEMOTHERAPY, "Combo_Box", 0)
...
BEGIN_EASYSIZE_MAP(CManagerDlg)
	...
	EASYSIZE(IDC_LYMPH_GLAND_2_STATIC, IDC_MFCMENUBUTTON_GLAND, ES_KEEPSIZE, ES_KEEPSIZE, IDC_MFCMENUBUTTON_GLAND, 0)
	...
	EASYSIZE(IDC_PATHOLOGY_ADENOCARCINOMA_STATIC, IDC_MFCMENUBUTTON, ES_KEEPSIZE, ES_KEEPSIZE, IDC_MFCMENUBUTTON, 0)
...
BOOL CManagerDlg::OnInitDialog()
{
	...
	m_MFCMenuGlandCtrl.m_hMenu = pMenu->GetSubMenu(2)->GetSafeHmenu();
	//////////////////////////////////////////////////////////////////////////
	CONNECTSTATICCTRL;
...
{
	CFindDlg * dlg = new CFindDlg;
	dlg->Create(IDD_FOUND_DLG);
